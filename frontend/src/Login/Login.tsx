...
function Login() {
  ...
  return (
    <div className='flex h-screen w-screen justify-center items-center bg-[url(src/assets/images/chat-image-background.jpg)] bg-cover animate-slide-down blur-none z-0'>
      <div className='flex flex-col p-7 bg-white h-72 w-fit rounded-md items-center justify-center shadow-2xl shadow-gray-800 animate-bounce-twice z-10'>
