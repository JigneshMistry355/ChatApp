...
function Home() {
  return (
    <>
        <div className='fixed h-screen w-screen bg-[url(/public/assets/images/Homebg.avif)] bg-cover animate-slide-down z-0'></div>
        <div className='flex flex-col h-screen '>
            ...
            <div className='flex flex-grow z-10'>
                  <div className='flex justify-center items-center w-screen bg-white h-full opacity-70 bg-[url(/public/assets/images/images.jpg)]'>
